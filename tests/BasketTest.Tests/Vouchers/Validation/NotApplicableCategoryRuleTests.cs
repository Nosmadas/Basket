...
{
    public class NotApplicableCategoryRuleTests
    {
        private NotApplicableCategoryRule _rule = new NotApplicableCategoryRule();
        ...
        public void Validate_GivenInvalidVoucherReturnInvalidItem()
        {
            var products = new[]
           {
            ...
            var vouchers = new[]
            {
                new OfferVoucher(5, 40, ProductCategory.HeadGear)
            };
